...
<div
	...
	<img class="animation__wobble" src="<c:url value='/templates/admin/dist/img/AdminLTELogo.png' />"
...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
	...
	<a href="<c:url value='/admin' />" class="brand-link"> <img
		...
		<span class="brand-text font-weight-light">QLBV_TMD</span>
	</a>
	...
	<div class="sidebar">
		...
		<div class="user-panel mt-3 pb-3 mb-3 d-flex">
			<div class="image">
				<img src="<c:url value='/templates/admin/dist/img/avatar.png' />" class="img-circle elevation-2"
					alt="User Image">
			</div>
			<div class="info">
               ...
               with font-awesome or any other icon font library -->
				<li class="nav-item menu-open"><a href="#"
					...
					<ul class="nav nav-treeview">
						...
						<li class="nav-item"><a href="<c:url value='/admin/staff/list' />" class="nav-link" id="menu_staff">
